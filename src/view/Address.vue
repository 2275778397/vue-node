    ...
    <div>
                ...
                <div class="checkout-addr">
                    ...
                    <!-- <div class="check-step">
                        <ul>
                            ...
                            <li><span>生成</span> 订单</li>
                            <li><span>订单</span> 确认</li>
                        </ul>
                    </div> -->
                    <!-- address list -->
                    <div class="page-title-normal checkout-title">
                        <h2><span>用户地址区域</span></h2>
                    </div>
                        ...
                        <div class="addr-list">
                            <ul>
                                <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':checkIndex==index}" @click="checkIndex=index;selectAddId=item.addressId">
                                    <dl>
                                        <dt>用户姓名:{{item.userName}}</dt>
                                        <dd class="tel">地址:{{item.streetName}}</dd>
                                        <dd class="tel">门牌号:{{item.postCode}}</dd>
                                        <dd class="tel">用户电话:{{item.tel}}</dd>
                                    </dl>
                                    ...
                                    <div class="addr-opration addr-set-default">
                                        <a href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault" @click="setDefault(item.addressId)"><span>Set default</span></a>
                                    </div>
                                    <div class="addr-opration addr-default" v-if="item.isDefault">Default address</div>
                                </li>
                                <li class="addr-new" @click="addAddre=true">
                ...
                <i class="i-up-down">
                  ...
                  <i class="i-up-down-r"></i>
                    ...
                    <div class="next-btn-wrap">
                        <a class="btn btn--m btn--red" href="/#/productShow">返回</a>
                        <router-link v-bind:to="{path:'orderConfirm',query:{'addressId':selectAddId}}" class="btn btn--m btn--red" href="#">Next</router-link>
                    </div>
                </div>
            </div>
        </div>
        <Modal :mdShow="isMdShow" @close="closeModal">
            ...
            <div slot="btnGroup">
                ...
                <a class="btn btn--m btn--red" href="javascript:;" @click="isMdShow = false">关闭</a>
            </div>
        </Modal>
        <Modal :mdShow="isDelete" @close="closeModal">
            ...
            <div slot="btnGroup">
                <a class="btn btn--m" href="javascript:;" @click="isDelete = false">继续删除</a>
                <a class="btn btn--m btn--red" href="javascript:;" @click="isDelete = false">取消</a>
            </div>
        </Modal>
        <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show': addAddre}">
            <div class="md-modal-inner">
                <div class="md-top">
                    <div class="md-title">新增用户地址</div>
                    <button class="md-close" @click="addAddre=false">Close</button>
                </div>
                <div class="md-content">
                    <div class="confirm-tips">
                        <ul>
                            <li class="regi_form_input">
                                <input type="text" v-model="addressid " tabindex="1 " name="AddressId " class="regi_login_input regi_login_input_left " placeholder="用户ID " data-type="loginname ">
                            </li>
                            <li class="regi_form_input ">
                                <input type="text " v-model="addressName " tabindex="1 " name="Addressname" class="regi_login_input regi_login_input_left " placeholder="用户名" data-type="loginname ">
                            </li>
                            <li class="regi_form_input ">
                                <input type="text " v-model="address" tabindex="1 " name="Addressname " class="regi_login_input regi_login_input_left " placeholder="用户地址" data-type="loginname ">
                            </li>
                            <li class="regi_form_input ">
                                <input type="text " v-model="addressPost" tabindex="1 " name="addressPost " class="regi_login_input regi_login_input_left " placeholder="用户门牌号" data-type="loginname ">
                            </li>
                            <li class="regi_form_input noMargin ">
                                <input type="text " v-model="addressTel " tabindex="2 " name="AddressTel " class="regi_login_input regi_login_input_left login-input-no input_text " placeholder="用户电话">
                            </li>
                        </ul>
                    </div>
        ...
        <div class="md-overlay" v-if="addAddre" @click="addAddre=false"></div>
